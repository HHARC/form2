...
//#endregion
//#region src/components/registration/RegistrationPageShell.tsx
var banners = [
	{
...
function RegistrationPageShell({ children }) {
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-64 bg-[linear-gradient(110deg,oklch(0.19_0.045_155),oklch(0.29_0.07_153))]" }),
			/* @__PURE__ */ jsx("div", {
				className: "relative w-full",
				children: /* @__PURE__ */ jsx(BannerSlideshow, {})
			}),
			/* @__PURE__ */ jsxs("div", {
...
function BannerSlideshow() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: banners.map((banner, index) => /* @__PURE__ */ jsx("img", {
				src: banner.src,
				alt: banner.alt,
			...
			children: banners.map((_, index) => /* @__PURE__ */ jsx("button", {
				type: "button",
