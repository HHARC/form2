...
//#endregion
//#region src/routes/players.tsx?tsr-split=component
...
function PlayersPage() {
	...
	const [roster, setRoster] = useState([...PLAYER_ROSTER]);
	const [managing, setManaging] = useState(false);
	const [playerName, setPlayerName] = useState("");
	const [managerMessage, setManagerMessage] = useState("");
	const players = useMemo(() => submissions.length > 0 ? matchRosterPlayers(submissions, roster) : [], [roster, submissions]);
	useEffect(() => {
		try {
	...
	async function exportPdf() {
		...
		try {
			const { createPlayerPdf, downloadPlayerPdf } = await import("./player-pdf-BQQIueHE.js");
			...
			children: [
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("h1", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: [
									managing ? /* @__PURE__ */ jsx(X, { className: "size-4" }) : /* @__PURE__ */ jsx(Settings2, { className: "size-4" }),
									" ",
									managing ? "Close manager" : "Manage players"
								]
							}), !loading && !error && players.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [downloadingAll ? /* @__PURE__ */ jsx(LoaderCircle, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(Download, { className: "size-4" }), downloadingAll ? "Preparing" : "Download all"]
								...
								children: [exportingPdf ? /* @__PURE__ */ jsx(LoaderCircle, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(FileDown, { className: "size-4" }), exportingPdf ? "Preparing PDF" : "Export PDF"]
							})] })]
						})]
					}), managing && /* @__PURE__ */ jsxs("aside", {
						id: "player-manager",
						...
						children: [
							/* @__PURE__ */ jsxs("form", {
								...
								children: [/* @__PURE__ */ jsxs("label", {
									...
									children: ["Add by full registration name", /* @__PURE__ */ jsx("input", {
										value: playerName,
				...
				loading ? /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(LoaderCircle, { className: "size-5 animate-spin text-[#c51d2b]" }), " Loading players"]
					})
				...
				}) : players.length === 0 ? /* @__PURE__ */ jsx("div", {
					className: "min-h-64 border-y border-black/20 py-20 text-center",
					children: /* @__PURE__ */ jsx("p", {
						className: "font-display text-2xl font-black",
					...
					children: players.map((player, index) => /* @__PURE__ */ jsxs("article", {
						...
						children: [
							managing && /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Minus, { className: "size-3.5" }), " Remove"]
							}),
							/* @__PURE__ */ jsx("div", {
