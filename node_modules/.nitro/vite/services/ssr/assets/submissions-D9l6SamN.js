import { t as logo_default } from "./logo-BQTsA3vG.js";
import { n as REGISTRATION_PHOTOS_PUBLIC_BASE_URL, t as API_BASE_URL } from "./api-DpyJ30dE.js";
import { n as cn, t as Button } from "./button-B2LyfGb_.js";
import { n as Alert, r as AlertDescription, t as Input } from "./input-CIuoq6qx.js";
import * as React from "react";
import { useEffect, useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { CalendarDays, Download, Eye, FileArchive, FileImage, Loader2, RefreshCcw, Search, TableProperties, X } from "lucide-react";
...
//#endregion
//#region src/routes/submissions.tsx?tsr-split=component
var columns = [
	"First Name",
	"Last Name",
	"Email",
...
function SubmissionsPage() {
	...
	const totalFiles = useMemo(() => submissions.filter((submission) => getFileUrl(submission)).length, [submissions]);
	...
	const filteredFiles = useMemo(() => filteredSubmissions.filter((submission) => getFileUrl(submission)).length, [filteredSubmissions]);
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							children: [
								...
								/* @__PURE__ */ jsxs(Button, {
									...
									disabled: loading,
									children: [loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(RefreshCcw, { className: "h-4 w-4" }), "Refresh"]
								}),
								/* @__PURE__ */ jsxs(Button, {
									type: "button",
									variant: "outline",
									...
									children: [downloadingPhotos ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(FileArchive, { className: "h-4 w-4" }), downloadingPhotos ? "Preparing ZIP" : "Download Photos"]
								}),
								/* @__PURE__ */ jsxs(Button, {
									type: "button",
									className: "h-11 rounded-xl",
									...
									children: [/* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }), "Export Excel"]
								})
							]
						})]
					}),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-3",
								children: [
									/* @__PURE__ */ jsx(TableProperties, { className: "h-5 w-5 text-primary" }),
									/* @__PURE__ */ jsx("p", {
										className: "font-semibold text-foreground",
										children: "Submitted entries"
									}),
									hasSearchQuery && /* @__PURE__ */ jsxs("span", {
								...
								children: [
									...
									hasSearchQuery && /* @__PURE__ */ jsx(Button, {
										type: "button",
										variant: "ghost",
										size: "icon",
								...
								children: [
									...
									/* @__PURE__ */ jsx("tbody", { children: loading ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
										...
										children: /* @__PURE__ */ jsxs("span", {
											...
											children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Loading submissions"]
										})
									}) }) : submissions.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
										colSpan: columns.length,
										className: "px-6 py-16 text-center text-muted-foreground",
										children: "No submissions found."
									}) }) : filteredSubmissions.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
										colSpan: columns.length,
										className: "px-6 py-16 text-center text-muted-foreground",
											...
											children: [
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: /* @__PURE__ */ jsx("div", {
														...
														children: (submission.notAvailableOn ?? submission.not_available_on ?? []).length > 0 ? (submission.notAvailableOn ?? submission.not_available_on ?? []).map((matchName) => /* @__PURE__ */ jsx(Badge, {
															variant: "secondary",
															className: "rounded-full",
															children: matchName
														}, matchName)) : /* @__PURE__ */ jsx("span", {
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: fileUrl ? /* @__PURE__ */ jsxs(Button, {
														type: "button",
														variant: "ghost",
														...
														children: [/* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" }), "View"]
													}) : /* @__PURE__ */ jsx("span", {
														className: "text-muted-foreground",
														children: "No file"
													})
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					...
					children: [/* @__PURE__ */ jsxs(DialogHeader, {
						...
						children: [/* @__PURE__ */ jsxs(DialogTitle, {
							...
							children: [/* @__PURE__ */ jsx(FileImage, { className: "h-5 w-5 text-primary" }), "Uploaded file"]
						}), /* @__PURE__ */ jsx(DialogDescription, { children: selectedFile?.name })]
